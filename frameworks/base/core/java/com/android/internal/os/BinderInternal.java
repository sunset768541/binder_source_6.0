...
public class BinderInternal {
     ...
     * other services.
     */
    //调用navtie方法，返回一个Java接口
    public static final native IBinder getContextObject();//IServiceManager 返回编号为0的SysterServer用于查找其他的系统服务 在android_os_BinderInternal_getContextObject
